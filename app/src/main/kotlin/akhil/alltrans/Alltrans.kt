...
class Alltrans : IXposedHookLoadPackage {
    ...
    override fun handleLoadPackage(lpparam: LoadPackageParam) {
        ...
        // A inicialização do HashMap foi removida.
        // O acesso ao getter de 'cache' garante a inicialização do LruCache, se necessário.
        // O log de inicialização já está no getter.
    ...
    companion object {
        ...
        // val hookAccess: Semaphore = Semaphore(1, true) // Removido conforme solicitado
        ...
        // Alterado de HashMap para LruCache. Definindo um tamanho máximo (ex: 200).
        const val CACHE_MAX_SIZE = 200 // Ou o valor definido anteriormente
        ...
        var cache: LruCache<String, String>?
            get() {
                if (_cache == null) {
                    ...
                    // Log.d("AlltransCache", "LruCache inicializado") // Log opcional para depuração
                    Utils.debugLog("AllTrans: LruCache inicializado com tamanho $CACHE_MAX_SIZE") // Log existente mantido
                }
                return _cache
            }
            set(value) {
